window.onload = async function init() {
    ...
    function render() {
        ...
        var rotationMatrix = q_rot.get_mat4();
        ...
        var modelViewMatrixGround = mult(viewMatrix, translate(0, -1.5, 2));        
    ...
    // Function to initialize mouse event handlers using quaternions
    function initEventHandlers(canvas) {
        ...
        canvas.onmousemove = function(ev) { // Mouse is moved
            ...
            // Update the overall rotation quaternion
            q_rot = q_inc.multiply(q_rot);
