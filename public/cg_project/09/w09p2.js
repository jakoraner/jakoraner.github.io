window.onload = async function init() {
    ...
    var viewMatrix = lookAt(vec3(0.0, 1.0, 3.0), // Eye position
    ...
    // Start rendering if both ground and teapot are loaded
    if (groundLoaded) {
        render();
    }
    ...
    function render() {
        ...
        modelViewMatrixGround = mult(viewMatrix, modelViewMatrixGround);
