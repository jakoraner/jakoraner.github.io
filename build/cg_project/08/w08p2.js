window.onload = function() {
    ...
    // Create a one-color dark black texture for shadows (gl.TEXTURE2)
    var texture2 = gl.createTexture();
    gl.activeTexture(gl.TEXTURE2);
    gl.bindTexture(gl.TEXTURE_2D, texture2);
    var shadowColor = new Uint8Array([0, 0, 0, 200]); // RGBA: Dark black with alpha = 200 for semi-transparency
    gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, 1, 1, 0,
                gl.RGBA, gl.UNSIGNED_BYTE, shadowColor);
    ...
    function render() {
        ...
        var yPlane = -1.0;
        var d = -(lightPosition[1] - yPlane); // d = -(y_l - y_g)
    ...
    // The image.onload function is already set up above
};