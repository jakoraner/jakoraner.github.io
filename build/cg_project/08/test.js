window.onload = function() {
    ...
    var gl = WebGLUtils.setupWebGL(canvas, { alpha: false }); // Disable browser compositing influence
    if (!gl) {
    ...
    var isShadowLoc = gl.getUniformLocation(program, "isShadow"); // Get isShadow uniform location
    ...
    var quad1ModelMatrix = mat4(); // Identity matrix
    var quad2ModelMatrix = mat4(); // Identity matrix
    ...
    function render() {
        ...
        var d = -(lightPosition[1] - (yPlane + epsilon));
        ...
        gl.uniform1i(isShadowLoc, false); // Not drawing shadows
        ...
        gl.uniform1i(isShadowLoc, true); // Drawing shadows
        gl.uniform1f(visibilityLoc, 0.5); // Set visibility to 0.5 for semi-transparent shadows

        // Bind the ground texture for shadows
        gl.activeTexture(gl.TEXTURE0);
        gl.bindTexture(gl.TEXTURE_2D, texture0);
        gl.uniform1i(textureLoc, 0);
        ...
        // Disable blending after drawing shadows
        gl.disable(gl.BLEND);
