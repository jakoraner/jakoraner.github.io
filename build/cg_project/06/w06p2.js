window.onload = function() {
    ...
    // Get controls
    var wrapModeSelect = document.getElementById("wrap-mode");
    var minFilterSelect = document.getElementById("min-filter");
    var magFilterSelect = document.getElementById("mag-filter");
    var applySettingsButton = document.getElementById("apply-settings");

    // Function to apply texture parameters and redraw the scene
    function applyTextureSettings() {
        // Get selected wrap mode
        var wrapMode = gl[wrapModeSelect.value];
        // Get selected minification filter
        var minFilter = gl[minFilterSelect.value];
        // Get selected magnification filter
        var magFilter = gl[magFilterSelect.value];
        ...
        if (isMipMapFilter(minFilter) || isMipMapFilter(magFilter)) {
    ...
    // Helper function to determine if a filter requires mipmaps
